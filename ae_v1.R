# Algoritmo evolutivo, versão 1
# Esse algoritmo avalia uma solução candidata
#  com base em seu número de bits.
...
ae_v1 <- function(tc, ng) {
  ...
  for (i in 1:ng) {
    ...
    cromossomo[pmut] = !cromossomo[pmut]
